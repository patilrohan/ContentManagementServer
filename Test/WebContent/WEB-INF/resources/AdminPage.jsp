...
<header>
   <div align="center" > ${hmsg} </div>        <div align="right" >User<a href="./logout"><font size="3" color="white">(Logout)</font></a>  </div>                                   
</header>
...
<nav><pre>
  <ul>
    ...
    <li><a href="./update">View Article</a></li>
    
    <li><a href="./Deactivate">View Comments</a></li>
